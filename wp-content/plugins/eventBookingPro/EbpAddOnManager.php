...
class EbpAddOnManager {
	...
	public static function useSliderAddon(){
		return (get_option("ebp_uses_slider") == 1);
	}
	...
	public static function getAddonsPage(){
		...
		$html .= '<div class="addonCnt">';
			$html .= '<h3>EBP Slider </h3>';
			$html .= '<p class="desc">Display events in a horizontal/vertical slider.</p>';

			if (self::useSliderAddon()) {
				$html .= '<span>Active</span>';
			} else {
				$html .= '<span><a href="http://iplusstd.com/item/eventBookingPro/example/slider/">View & Buy</a> or enable the Addon</span>';
			}
